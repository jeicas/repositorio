...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-04-2015 a las 17:53:46
...
--
CREATE DATABASE IF NOT EXISTS `bdgenerica` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `bdgenerica`;
...
(2, 'Autorización', '', NULL, '', NULL),
(3, 'Reportes', '', NULL, '', NULL),
(4, 'Sesión', '', NULL, '', NULL),
(5, 'Usuario', 'registro1', 'usuario', 'registrar.UsuarioController', 1),
(6, 'Registrar autorización', 'registro1', 'autorizacion', 'registrar.AutorizacionController', 2),
(7, 'Empleados autorizados', 'registro1', 'autorizados', 'consultar.AutorizadosController', 2),
(8, 'Empleado', 'registro1', 'empleado', 'registrar.EmpleadoController', 1),
...
(11, 'Consultar autorización', 'registro1', 'consultarautorizados', 'consultar.ConsultarAutorizadosController', 2),
(12, 'Autorizaciones procesadas', 'registro1', 'procesadas', 'consultar.ProcesadosController', 2),
...
(4, 2, 'No posee descripcion'),
(4, 4, 'No posee descripcion'),
(4, 7, 'No posee descripcion'),
(4, 9, 'No posee descripcion'),
(4, 10, 'No posee descripcion'),
(4, 12, 'No posee descripcion');
...
`id` int(3) NOT NULL,
  ...
  `estatus` tinyint(1) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=53 DEFAULT CHARSET=latin1 COMMENT='Usuario que hereda de persona';
...
(1, 'PERSONAL', 23364399, 'V', 'e10adc3949ba59abbe56e057f20f883e', 1, NULL, NULL, 1),
(4, 'Fremberling', 202020, 'V', 'e10adc3949ba59abbe56e057f20f883e', 1, NULL, NULL, 1),
(52, 'INFORMATICA', 18, 'V', 'e10adc3949ba59abbe56e057f20f883e', 1, NULL, NULL, 1);
