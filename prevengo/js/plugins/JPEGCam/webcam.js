...
window.webcam = {
	...
	swf_url: BASE_PATH+'js/plugins/JPEGCam/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
	shutter_url: BASE_PATH+'js/plugins/JPEGCam/shutter.mp3', // URI to shutter.mp3 sound
